...
#SBATCH --job-name=fmriprep_study-cneuromod.petit-prince_sub-05_ses-002.job
#SBATCH --output=/lustre04/scratch/bpinsard/petit-prince.fmriprep/code/fmriprep_study-cneuromod.petit-prince_sub-05_ses-002.out
#SBATCH --error=/lustre04/scratch/bpinsard/petit-prince.fmriprep/code/fmriprep_study-cneuromod.petit-prince_sub-05_ses-002.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.petit-prince_sub-05_ses-002_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.petit-prince_sub-05_ses-002 ; fi 
